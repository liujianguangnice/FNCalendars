...
final class CalendarAdapter extends RecyclerView.Adapter implements PinnedHeaderRecyclerView.PinnedHeaderAdapter {
    ...
    CalendarAdapter(Context context,boolean doubleSelectedMode) {
        mLayoutInflater = LayoutInflater.from(context);
        ...
        switch (viewType) {
            ...
            case CalendarEntity.ITEM_TYPE_DAY: {
                ...
                if(mDoubleSelectedMode){
                    dayViewHolder.dayTextDoubleBg.setVisibility(View.VISIBLE);
                    if( calendarEntity.selectedType==CalendarEntity.SELECTED_TYPE_SELECTED){
                        dayViewHolder.dayTextDoubleBg.setSelected(true);
                    }else{
                        dayViewHolder.dayTextDoubleBg.setSelected(false);
                    }
                }else{
                    dayViewHolder.dayTextDoubleBg.setVisibility(View.INVISIBLE);
                    if( calendarEntity.selectedType==CalendarEntity.SELECTED_TYPE_SELECTED){
                        dayViewHolder.dayTextView.setSelected(true);
                    }else{
                        dayViewHolder.dayTextView.setSelected(false);
                    }
                }
    ...
    private static final class DayViewHolder extends RecyclerView.ViewHolder {
        ...
        public final TextView dayTextDoubleBg;

        DayViewHolder(View itemView) {
            super(itemView);

            dayTextDoubleBg = (TextView) itemView.findViewById(R.id.day_double_bg);
